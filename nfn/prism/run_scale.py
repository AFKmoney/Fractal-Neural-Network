...
from nfn.prism.baselines import build_model
from nfn.prism.config import PrismConfig
from nfn.prism.curriculum import CurriculumSchedule, TokenRecycler
from nfn.prism.data_scale import Batch, _load_tokenizer, build_dataloader, batched
from nfn.prism.modular import MIX_MODULAR, assemble_experts, modular_config
from nfn.prism.train_scale import PRESETS, TrainArgs, get_mix, mix_summary
...
def train(args: TrainArgs):
    ...
    if args.smoke_datasets:
        ...
        from nfn.prism.train_scale import DatasetSpec
